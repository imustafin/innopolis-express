...
public class HorizaentalFoodAdapter extends RecyclerView.Adapter {

    List<Product> mProducts = new ArrayList<>();
    private boolean mIsMoofi;

    public HorizaentalFoodAdapter(boolean isMoofi) {
        mIsMoofi = isMoofi;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new FoodViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.home_card_list_item_horizental, viewGroup, false),mIsMoofi);
    }
