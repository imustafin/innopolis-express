...
public class Salah_PickMealFragment extends Fragment implements Step {

    private RecyclerView mRecycler;
    private RecyclerView mRecycler2;
    private Salah_FoodAdapter mAdapter;
    public static Salah_PickMealFragment newInstance() {
        return  new Salah_PickMealFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.salah_fragment_pick_meal, container, false);
        ...
        mAdapter.setMealList(Meal.buildMeals());
